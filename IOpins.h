...
#define IR_RIGHT_1			   23 // Infrared sensor right 1
#define IR_RIGHT_2			   25 // Infrared sensor right 2
#define IR_LEFT_1			     27 // Infrared sensor left 1
#define IR_LEFT_2			     29 // Infrared sensor left 2
